...
func TestWrite(t *testing.T) {
	...
	tests := []struct{
		...
		},
		{
			...
			Expected:   []byte{0x34,0x12,0x78,0x56,0xbc,0x9a,0xf0,0xde},
		},
		{
		...
		},
		{
			...
			Expected:   []byte{0x78,0x56,0x34,0x12,0x89,0x67,0x45,0x23,0x9a,0x78,0x56,0x34,0xab,0x89,0x67,0x45},
		},
		{
		...
		},
		{
			...
			Expected:   []byte{0xf0,0xde,0xbc,0x9a,0x78,0x56,0x34,0x12, 0xce,0x8a,0x46,0x02,0xdf,0x9b,0x57,0x13, 0x92,0xf3,0xa0,0x24,0xaf,0x94,0x1d,0x15, 0xe4,0xf5,0x7b,0xee,0x8b,0xd8,0xe2,0xf4},
		},
		{
...

		{
			...
			Expected: []byte{0xcd,0xab, 0x3c,0x2d,0x1e,0x0f, 0x43,0x48,0x45,0x45,0x59, 0xef,0xcd,0xab,0x89,0x67,0x45,0x23,0x01},
		},
...

		{
			...
			Expected: []byte{0x00,0x00,0x00,0x00, 0x01,0x00,0x00,0x00,   0x00,0x00, 0x00,0x00, 0x00,0x00, 0x00,0x00,   0x01,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,   0x01,0x00,0x00,0x00, 0x01,0x00, 0x00,0x00,   0x01,0x00,0x00,0x00, 0x00,0x00,0x00,0x00},
		},
	}
	...
	for testNumber, test := range tests {
		...
		n64, err := littleendian.WriteTo(&buffer, test.Value)
		if nil != err {
